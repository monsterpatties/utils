...
{	
	 ...
	 * @author ...
	 */
	public class MochiController extends EventDispatcher
	{
		/*---------------------------------------------------------------Constant-----------------------------------------------------------*/
		
		/*---------------------------------------------------------------Properties-----------------------------------------------------------*/
		private static var _instance:MochiController;
		...
		/*---------------------------------------------------------------Constructor-----------------------------------------------------------*/
		public function MochiController( enforcer:SingletonEnforcer ) 
		{
			init();
		}
		
		
		public static function getInstance():MochiController
		{
			if ( MochiController._instance == null ) {
				MochiController._instance = new MochiController( new SingletonEnforcer() );
			}
			
			return MochiController._instance;
		}
		...
		public function startGamePlay():void 
		{
			...
			trace("[MochiController] startGamePlay...");
		}
